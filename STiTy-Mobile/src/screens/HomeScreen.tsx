          ...
          <View style={[S.pickerSheet, { paddingBottom: Math.max(insets.bottom, 16) + 16 }]}>
            ...
            {menuPage === 'terms' && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Text style={S.detailH4}>{ui.termsH4}</Text>
                <Text style={S.detailP}>{ui.termsP4}</Text>
