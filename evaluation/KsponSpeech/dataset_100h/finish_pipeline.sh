...
PY="${PY:-python}"
# 리포 밖 원본 데이터 — KSPON_EVAL_ROOT 로 덮어쓴다
KSPON_EVAL_ROOT="${KSPON_EVAL_ROOT:-$HOME/datasets/KsponSpeech_eval}"
