...
rm -f $OUT/cache/segment_granite.json $OUT/cache/segment_qnext.json
label granite-16k granite none > $L/granite.log 2>&1
label qnext-16k   qnext   none > $L/qnext.log 2>&1
echo CHAIN2DONE; date
