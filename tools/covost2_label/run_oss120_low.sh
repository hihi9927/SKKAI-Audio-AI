...
echo "===== oss120-16k / effort=low / 예산16000 / timeout2400 / batch6 / 20문장 ====="; date
...
python tools/covost2_label/label_covost2.py --provider local --prompt $P \
  --out   $OUT/labels/covost2_20_oss120_low.jsonl \
  --cache $OUT/cache/segment_oss120_low.json \
  --model oss120-16k --workers 4 --limit 20 \
  --seg-reasoning-effort low \
