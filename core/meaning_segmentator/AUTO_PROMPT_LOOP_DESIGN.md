...
백엔드는 삭제됐다. 현행 `xlmr-anli` 는 바닥이 **길수록 크고**, 크기도 무시할 수준이 아니다
(재측정 `runs/noise_floor_xlmr/`, 문장 611/350/100):

| 길이 | German 바닥 | 관측 경계 mean | 바닥/관측 |
|---|---|---|---|
| 1-2 | 0.0237 | 0.0693 | 34% |
| 3-4 | 0.0359 | 0.0510 | 70% |
| 5-6 | 0.0473 | 0.0490 | **96%** |
| 7-9 | 0.0673 | 0.0685 | **98%** |
| 10-14 | 0.0858 | 0.0973 | 88% |
| 15+ | 0.1065 | 0.1102 | **97%** |

즉 **실제 신호는 짧은 hypothesis(1-4어절)에 몰려 있고, 5어절 이상에서는 관측 평균이 사실상
바닥이다.**
