...
COMET 이 같은 방향의 번역을 재고, 문장도 같다(§1 의 en 기준 정렬 재사용).
    ...
    python -m core.meaning_segmentator.autoseg.scoring.comet_x2en \
...
from ..paths import MANIFEST_DIR, REPO_ROOT, RUNS_DIR
...
def main() -> int:
    ...
    from core.meaning_segmentator.autoseg.scoring.bleu_eval import laal_ms
